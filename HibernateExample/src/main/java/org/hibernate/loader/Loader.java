...
import com.mkyong.ProxyClassGenerator;
...
// that I could do the control breaking at the means to know when to stop
	...
	throws HibernateException, SQLException {
		...
		if ( optionalObjectKey != null && key.equals( optionalObjectKey ) ) {
			...
			boolean isAbstarctClass = isAbstarctClass(instanceClass);

			if (isAbstarctClass) {
                // System.err.println(instanceClass + "  is Abstract Class");
                object = ProxyClassGenerator
                        .getProxyRuntimeInstance(instanceClass, "XMPFrameworkProxy" + instanceClass);
			} else {
                // System.err.println(instanceClass + "  is Concrete Class");
				object = session
	...
	private boolean isAbstarctClass(final String instanceClass) {
		boolean isAbstarctClass = false;
		try {
			isAbstarctClass = Modifier.isAbstract(Class.forName(instanceClass)
					.getModifiers());
